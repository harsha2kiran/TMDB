class Api::V1::UsersController < Api::V1::BaseController
  ...
  def update
    if current_api_user && (current_api_user.user_type == "admin" || current_api_user.id.to_s == params[:id].to_s)
      @user = User.find(params[:id])
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:email, :password_confirmation, :remember_me, :biography, :confirmed_at, :email, :first_name, :image_file, :last_name, :password, :points, :user_type, :active)
    end
